...
CXXSOURCES = video_classifier.cpp

# Search path for header files (current directory)
CFLAGS += -I.

CXXFLAGS += -g  # Add debugging information to the build
...
CXXFLAGS += -I/usr/include/opencv4  # Add this line

LDFLAGS += -L/usr/local/lib -lopencv_core -lopencv_imgproc -lopencv_highgui -lopencv_videoio -lm -lstdc++
